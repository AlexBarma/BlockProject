            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row mb-3 align-items-center">
                        <h1 class="m-0 p-2">{{ $tag->title }}</h1>
                        <a class="text-success p-2" href="{{ route('admin.tags.edit', $tag->id) }}">
                            <i class="fas fa-solid fa-wrench"></i>
                        </a>
                        <form class="p-2" action="{{ route('admin.tags.destroy', $tag->id) }}" method="POST">
                            @csrf
                            @method('delete')
